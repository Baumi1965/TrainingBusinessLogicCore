...
namespace Training.BusinessLogic.Zeiterfassung
{
    public class FeiertagLogic
    {
        ...
        private FeiertagLogic(int year)
        {
            ...
            this.feiertage.Add(new Feiertag(true, new DateTime(year, 5, 1), "Staatsfeiertag"));
            ...
            this.feiertage.Add(new Feiertag(true, new DateTime(year, 10, 26), "Nationalfeiertag"));
            this.feiertage.Add(new Feiertag(true, new DateTime(year, 11, 1), "Allerheiligen"));
            this.feiertage.Add(new Feiertag(true, new DateTime(year, 12, 8), "Maria Empfängnis"));
