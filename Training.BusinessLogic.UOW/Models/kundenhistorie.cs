...
namespace Training.BusinessLogic.UOW.Models
{
    ...
    public class kundenhistorie: XPLiteObject
    {
        public kundenhistorie(Session session) : base(session) { }
		...
		public DateTime? DatumAenderung
		{
			...
			set { SetPropertyValue<DateTime?>(nameof(DatumAenderung), ref fDatumAenderung, value); }
		}
		bool? fGeloescht;
		public bool? Geloescht
		{
			get { return fGeloescht; }
			set { SetPropertyValue<bool?>(nameof(Geloescht), ref fGeloescht, value); }
		}
